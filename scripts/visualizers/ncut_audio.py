...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="audio_ast_ncut_") as td:
        ...
        if args.ncut_mode == "global":
            ...
            eigvecs, clusters = run_ncut(global_features, args.n_eig, args.n_clusters, args.device, seed=args.seed, clusterer=args.ncut_clusterer, name="global NCut")
            ...
            for i, item in enumerate(items):
                ...
                cluster_rgb = embed_cluster_colors(eigvecs, item_clusters, args.embedder, args.seed)
